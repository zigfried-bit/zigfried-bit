# Github Stars Index
- [Github Stars Index](#github-stars-index)
  - [I :rainbow: SLAM](#i-rainbow-slam)
    - [a. :couple: Co-SLAM](#a-couple-co-slam)
    - [b. :camera: Visual-SLAM](#b-camera-visual-slam)
    - [c. :sparkler: LiDAR-SLAM](#c-sparkler-lidar-slam)
    - [d. :running: Dynamic-SLAM](#d-running-dynamic-slam)
  - [II :sparkles: Algorithm](#ii-sparkles-algorithm)
    - [a. PGO related](#a-pgo-related)
    - [b. place recogintion](#b-place-recogintion)
    - [c. localization](#c-localization)
    - [d. segmentation](#d-segmentation)
    - [e. communication](#e-communication)
    - [f. calibration](#f-calibration)
    - [g. object detection](#g-object-detection)
    - [h. tracking](#h-tracking)
  - [III :moneybag: Datasets](#iii-moneybag-datasets)
    - [a. signle](#a-signle)
    - [b. mulitiple](#b-mulitiple)
  - [IV :wrench: Tool](#iv-wrench-tool)
    - [a. SLAM related](#a-slam-related)
    - [b. system related](#b-system-related)
    - [c. dataset related](#c-dataset-related)
    - [d. ros related](#d-ros-related)
    - [f. coding](#f-coding)
  - [V :lollipop: Tips](#v-lollipop-tips)
    - [a. literature related](#a-literature-related)
    - [b. assorted](#b-assorted)
  - [VI :notebook: Note](#vi-notebook-note)
    - [a. SLAM related](#a-slam-related-1)
    - [b. tool related](#b-tool-related)
  ...
  - [VIII :triangular\_ruler: Lib](#viii-triangular_ruler-lib)
    ...
    - [c. slam related](#c-slam-related)
    - [d. big project](#d-big-project)


## I :rainbow: SLAM 
### a. :couple: Co-SLAM

### b. :camera: Visual-SLAM

### c. :sparkler: LiDAR-SLAM
...
### e. communication
- [SimpleUDPTCP](https://github.com/misaakidis/SimpleUDPTCP)
...
- [lidar_rtk_calibration](https://github.com/liyang-whu/lidar_rtk_calibration)
- [imu_lidar_calibration](https://github.com/unmannedlab/imu_lidar_calibration)
- [kalibr](https://github.com/ethz-asl/kalibr)
- [ILCC](https://github.com/mfxox/ILCC)
- [stereo-calibration](https://github.com/sourishg/stereo-calibration)
- [lidar_align](https://github.com/ethz-asl/lidar_align)

### g. object detection
- [ros-yolov5](https://github.com/OuyangJunyuan/ros-yolov5)
- [LidarRoadBoundaryDetection](https://github.com/wangguojun2018/LidarRoadBoundaryDetection)
- [3DLineDetection](https://github.com/xiaohulugo/3DLineDetection)
- [IR_detection](https://github.com/jingdao/IR_detection)

### h. tracking
- [deep_sort](https://github.com/nwojke/deep_sort)
- [ros-yolo-sort](https://github.com/engcang/ros-yolo-sort)
- [DeepSORT_YOLOv5_Pytorch](https://github.com/HowieMa/DeepSORT_YOLOv5_Pytorch)
- [classy-sort-yolov5](https://github.com/tensorturtle/classy-sort-yolov5)
...
- [BIThesis](https://github.com/BITNP/BIThesis)
...
- [books](https://github.com/DeepRobot2020/books)
- [slambook2](https://github.com/gaoxiang12/slambook2)

### b. tool related
- [vispy-tutorial](https://github.com/liubenyuan/vispy-tutorial)
- [CMakeTutorial](https://github.com/BrightXiaoHan/CMakeTutorial)
- [CMake-tutorial](https://github.com/TheErk/CMake-tutorial)
- [WSL-Guideline](https://github.com/iWangJiaxiang/WSL-Guideline)

### c. machine learning
- [pumpkin-book](https://github.com/datawhalechina/pumpkin-book)

### d. coding
- [Cpp-Primer-5th-Notes-CN](https://github.com/czs108/Cpp-Primer-5th-Notes-CN)
- [awesome-cs-books](https://github.com/imarvinle/awesome-cs-books)
- [git-emoji-guide](https://github.com/hooj0/git-emoji-guide)
